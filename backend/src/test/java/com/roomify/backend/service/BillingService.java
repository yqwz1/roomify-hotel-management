...
public class BillingService {
        ...
        public BillResponse closeBill(String confirmationNumber) {
                ...
                log.info("Bill closed for {} | totalPaid={} outstanding={}",
                                normalized, totalPaid, outstanding);
        ...
        private BillResponse buildBillResponse(
                ...
                if (auditBillCalculated) {
                        auditService.log("BILL_CALCULATED", normalizedConfirmation, "bill generated");
                }
        ...
        private List<BillLineItem> buildLineItems(
                ...
                items.add(new BillLineItem(
                                String.format("Room Charge (%d night%s x %s)",
                ...
                String vatPct = vatRate.multiply(BigDecimal.valueOf(100)).toPlainString();
