...
class RoomTypeIntegrationTest {
        ...
        void createRoomTypeWithDuplicateNameReturnsConflict() throws Exception {
                ...
                mockMvc.perform(post("/api/room-types")
                                ...
                                .andExpect(jsonPath("$.message")
                                                .value("Room type with name 'Standard Room' already exists"));
        }
        ...
        void getAllRoomTypesReturnsAllTypes() throws Exception {
                ...
                roomTypeRepository.save(
                                new RoomType("Standard", new BigDecimal("120.00"), 2, "WiFi, TV", "Standard room"));
                roomTypeRepository
                                .save(new RoomType("Deluxe", new BigDecimal("200.00"), 4, "WiFi, TV, Mini Bar",
                                                "Deluxe room"));
        ...
        void getRoomTypeByIdReturnsCorrectType() throws Exception {
                RoomType saved = roomTypeRepository.save(
                                new RoomType("VIP Suite", new BigDecimal("500.00"), 6, "WiFi, TV, Mini Bar, Jacuzzi",
                                                "VIP room"));
