      ...
      <CardContent className="p-4">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex min-w-0 items-start gap-3">
            <span className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-2xl bg-white text-brand-warning shadow-sm">
              <AlertTriangle className="h-5 w-5" />
            </span>
            <div className="min-w-0">
              <p className="text-sm font-black text-brand-ink">Safe demo fallback active</p>
              <p className="mt-1 text-sm font-medium leading-6 text-brand-warning">
                {message || DEFAULT_MESSAGE}
              </p>
              <p className="mt-1 text-xs font-bold text-brand-warning/80">
