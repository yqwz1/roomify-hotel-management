...
export default function GuestAssistantLauncher({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="fixed bottom-[calc(var(--roomify-mobile-nav-height)+env(safe-area-inset-bottom,0px)+1rem)] right-4 z-[70] inline-flex h-16 w-16 items-center justify-center rounded-full bg-[linear-gradient(135deg,#1A2B3A_0%,#285477_100%)] text-white shadow-[0_24px_60px_-22px_rgba(15,23,42,0.58)] transition hover:-translate-y-0.5 hover:shadow-[0_28px_70px_-24px_rgba(15,23,42,0.62)] sm:bottom-6 sm:right-6"
