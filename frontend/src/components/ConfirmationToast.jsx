...
export default function ConfirmationToast({ message, type = 'success', duration = 4000, onClose }) {
    ...
    const styles = {
        success: { bar: 'bg-green-500', bg: 'bg-white border-green-200', text: 'text-green-800', icon: '✅' },
        error: { bar: 'bg-red-500', bg: 'bg-white border-red-200', text: 'text-red-800', icon: '❌' },
        info: { bar: 'bg-blue-500', bg: 'bg-white border-blue-200', text: 'text-blue-800', icon: 'ℹ️' },
    };
