...
const PROTECTED_ROUTE_ROLE_MAP = {
  ...
  '/staff/guest-inbox': [ROLE_MANAGER, ROLE_STAFF],
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        translationKey: 'guestAssistantInbox',
        fallbackLabel: 'Guest Inbox',
        icon: LifeBuoy,
        roles: [ROLE_MANAGER],
      },
    ],
...
const GUEST_NAVIGATION_CONFIG = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        path: '/explore-hotels',
        translationKey: 'exploreHotels.nav',
        fallbackLabel: 'Explore Hotels',
        icon: Map,
        roles: [ROLE_GUEST],
      },
    ],
...
const DOCUMENT_TITLE_OVERRIDES = {
  ...
  '/staff/guest-inbox': ['guestAssistantInbox', 'Guest Inbox'],
