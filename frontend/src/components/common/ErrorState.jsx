...
const ErrorState = ({ title, message, onRetry }) => {
  ...
  return (
    <div className="motion-error-in motion-warning-shake-soft flex min-w-0 flex-col items-center justify-center rounded-3xl border border-brand-danger/25 bg-brand-danger/[0.05] p-8 text-center">
