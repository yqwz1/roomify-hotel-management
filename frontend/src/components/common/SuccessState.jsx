...
const SuccessState = ({ title, message }) => {
  ...
  return (
    <div className="flex min-w-0 flex-col items-center justify-center rounded-3xl border border-brand-success/25 bg-[linear-gradient(180deg,rgba(255,255,255,0.95),rgba(29,158,117,0.07))] p-8 text-center shadow-[0_20px_48px_-34px_rgba(29,158,117,0.45)]">
