...
export default function DashboardPanel({
  ...
  return (
    <section className={cn('motion-stagger-item motion-card-reveal min-w-0 rounded-[1.75rem] border border-brand-surface-border bg-white shadow-[0_18px_40px_-24px_rgba(15,23,42,0.28)]', className)}>
