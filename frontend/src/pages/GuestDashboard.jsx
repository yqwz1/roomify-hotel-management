        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="bg-white rounded-lg shadow p-6">
                    <div className="border-s-4 border-purple-600 ps-4 mb-6">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            >
                                <div className="text-blue-600 font-medium">{t('browseRoomsBtn') || 'Browse Rooms'}</div>
                            ...
                            <a
                                ...
                                className="block p-4 bg-white border border-gray-200 rounded-lg hover:border-blue-500 hover:shadow-md transition-all"
                            >
                                <div className="text-blue-600 font-medium">{t('myProfile') || 'My Profile'}</div>
                                <p className="text-sm text-gray-600 mt-1">
                            ...
                            <a
                                ...
                                className="block p-4 bg-white border border-gray-200 rounded-lg hover:border-blue-500 hover:shadow-md transition-all"
                            >
                                <div className="text-blue-600 font-medium">{t('helpSupport') || 'Help & Support'}</div>
                                <p className="text-sm text-gray-600 mt-1">
