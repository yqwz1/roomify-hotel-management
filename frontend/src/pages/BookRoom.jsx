                  ...
                  <div className="rounded-[1.5rem] border border-brand-surface-border bg-brand-surface-light p-4">
                    ...
                    <p className="mt-2 text-sm font-medium leading-6 text-brand-ink-muted break-words">
                      {translateWithFallback(
                        ...
                        isGuest
                          ? 'Your reservation will stay payment pending and unpaid until the demo payment succeeds. Failed demo payments cancel the reservation and release the room.'
            ...
            <div className="space-y-5">
              ...
              <div className="rounded-[1.5rem] border border-brand-surface-border bg-white p-4">
                ...
                <ul className="mt-3 space-y-2 text-sm font-medium leading-6 text-brand-ink-muted">
                  ...
                  <li>{translateWithFallback(t, 'bookRoomPage.paymentPolicyBody', isGuest ? 'Guest bookings cannot bypass payment. A successful demo payment is required before confirmation.' : 'Taxes and totals are generated by the backend pricing engine and revalidated on reservation creation.')}</li>
